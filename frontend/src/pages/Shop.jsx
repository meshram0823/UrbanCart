          ...
          <div className="bg-[#151515] p-3 mt-2 mb-2">
            ...
            <div className="p-5 w-[15rem]">
              <input
                ...
                border-gray-300 focus:outline-none focus:ring-pink-500 focus:border-pink-500 focus:border-2
                hover:border-pink-500 border-2 transition-colors duration-300"
              />
            </div>
